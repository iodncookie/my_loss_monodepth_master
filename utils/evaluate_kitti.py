...
parser.add_argument('--predicted_disp_path', type=str,   help='path to estimated disparities',      default='/data/tion/tmp/my_loss_vgg_kitti_batch_4_test/disparities_pp.npy')
parser.add_argument('--gt_path',             type=str,   help='path to ground truth disparities',   default='/data/tion/kitti/2015_kitti_val')
...
# parser = argparse.ArgumentParser(description='Evaluation on the KITTI dataset')
# parser.add_argument('--split',               type=str,   help='data split, kitti or eigen',         default='kitti')
# parser.add_argument('--predicted_disp_path', type=str,   help='path to estimated disparities',      default='/data/tion/workspace/cityscapes_disparities/disparities.npy')
# parser.add_argument('--gt_path',             type=str,   help='path to ground truth disparities',   default='/data/tion/cityscapes/disparity/val')
# parser.add_argument('--min_depth',           type=float, help='minimum depth for evaluation',        default=1e-3)
# parser.add_argument('--max_depth',           type=float, help='maximum depth for evaluation',        default=80)
# parser.add_argument('--eigen_crop',                      help='if set, crops according to Eigen NIPS14',   action='store_true')
# parser.add_argument('--garg_crop',                       help='if set, crops according to Garg  ECCV16',   action='store_true')
